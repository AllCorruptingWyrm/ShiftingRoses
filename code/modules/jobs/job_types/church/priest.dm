...
/mob/living/carbon/human/proc/coronate_lord()
	...
	coronated.job = "Maggiore" //Maggiore is used when checking if the ruler is alive, not "King" or "Queen". Can also pass it on and have the title change properly later.
