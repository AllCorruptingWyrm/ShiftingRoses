...
/obj/item/paper/heartfelt/Initialize()
	var/static/list/info = list(
		"Negotiate trade agreements with merchants in Palmos to facilitate the exchange of goods and resources between the two realms.",
		"Explore the mysteries of peninsula of Palmos, uncovering its secrets and hidden treasures.",
		"Establish a diplomatic alliance with the Doge of Palmos to strengthen the relationship between Heartfelt and Palmos.",
